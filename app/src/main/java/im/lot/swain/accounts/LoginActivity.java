...
import im.lot.swain.MainActivity;
import im.lot.swain.R;
import im.lot.yi.bean.dto.response.User;
import im.lot.yi.login.AccountsHelper;
...
public class LoginActivity extends AccountAuthenticatorActivity implements LoaderCallbacks<Cursor> {
    ...
    public void onReponseOk(String login, String accessToken) {
        User user = new User();
        user.login = login;
        user.name = login;
        user.email = login;
